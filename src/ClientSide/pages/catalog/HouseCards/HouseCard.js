...
import HouseImg from '../../../assets/img/HouseCard.png'
import CheckoutButton from "../../components/CheckoutButton";
import HouseImg2 from '../../../assets/img/HouseImgSlider.png'
import {useDispatch, useSelector} from "react-redux";
import {addHeartId} from "../../../redux/actions/houses";


function HouseCard({ address, author_id, bathrooms, style, bedrooms, codename, conditions, cost, floors, id, infrastructure, long_info, materials, name, short_info, size, square ,style_id, time, type, onClickAddHouse }) {
    ...
    return (
        <div className="card-wrapper">
            <div className="triangle">
                <svg onClick={() => onAddHouse(id)} id={id} className="heart" width="18" height="16" viewBox="0 0 18 16" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <Link to={`/house_page/${id}`}><div className="card-img">
            ...
            <div className="card-info">
                ...
                <div className="house-name">
                    <Link to={`/house_page/${id}`}><h1>{name}</h1></Link>
                </div>
                ...
                <div className="card-btns">
                    <div className="checkout">
                        <CheckoutButton className="white-checkout-btn" children={'Оформить заказ'} active={true}/>
                    </div>
                    <div className="open-redactor">
                        <CheckoutButton className="open-redactor-btn" children={'Открыть в редакторе'} active={true}/>
                    </div>
                </div>
            </div>
        </div>
