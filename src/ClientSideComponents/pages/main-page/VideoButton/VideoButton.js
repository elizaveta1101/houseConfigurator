    ...
    return (
        <>
            <div className="video-btn-circle">
                <svg className="video-btn-circle-1" width="110" height="110" viewBox="0 0 120 120" strokeWidth="2.5">
                    <circle className="video-btn-circle-1-preload" cx="60" cy="60" r="58.2" fill="none" stroke="#325FFF" opacity={0.1} strokeWidth="3" strokeDasharray="0 400"/>
                </svg>
                <svg className="video-btn-circle-2" width="110" height="110" viewBox="0 0 120 120" strokeWidth="2.5">
                    <circle className="video-btn-circle-2-preload" cx="60" cy="60" r="58.2" fill="none" stroke="#325FFF" opacity={0.1} strokeWidth="2" strokeDasharray="0 400"/>
                </svg>

                <div className="play-btn-hover">
                    <div className="btn-circle1-hover">
                        <svg className="btn-circle1" width="110" height="110" viewBox="0 0 120 120" strokeWidth="2.5">
                            <circle className="btn-circle1-preload" cx="60" cy="60" r="57.2" fill="none" stroke="#325FFF" strokeWidth="6" strokeDasharray="0 400"/>
                        </svg>
                    </div>

                    <div className="btn-circle2-hover">
                        <svg className="btn-circle2" width="110" height="110" viewBox="0 0 120 120" strokeWidth="2.5">
                            <circle className="btn-circle2-preload" cx="60" cy="60" r="57.2" fill="none" stroke="#325FFF" strokeWidth="3" strokeDasharray="0 400"/>
                        </svg>
                    </div>
