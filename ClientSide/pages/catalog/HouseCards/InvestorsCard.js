...
function InvestorsCard({ address, author_id, bathrooms, year_percent, style, bedrooms, codename, conditions, cost, floors, id, infrastructure, long_info, materials, name, short_info, size, square ,style_id, time, type, onClickAddHouse }) {

    const [filledHeart, setFilledHeart] = React.useState(false);

    const onAddHouse = () => {
        const obj = {address, bedrooms, cost, floors, name, size, square, style_id, id, year_percent, style, conditions}
        onClickAddHouse(obj)
    ...
    console.log('hearts_array: ',heart_ids)
    ...
    return (
        <div className="card-wrapper">
            <div className="triangle">
                <svg onClick={onAddHouse} className="heart" width="18" height="16" viewBox="0 0 18 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                {filledHeart && <svg className={filledHeart ? 'filled-heart': 'heart'} width="18" height="16" viewBox="0 0 18 16" fill="none"
            ...
            <div className="card-img">
                <Link to="/investors_house_page"><img src={InvestorsHouseImg} alt="InvestorsHouseImg"/></Link>
            </div>
            <div className="card-info">
                ...
                <div className="house-name">
                    <Link to="/investors_house_page"><h1>{name}</h1></Link>
                </div>
                        ...
                        <div className="right-house-feature">
                            <div className="house-feature house-feature__investors">
                                <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M13.334 4.66675H2.66732C1.93094 4.66675 1.33398 5.2637 1.33398 6.00008V12.6667C1.33398 13.4031 1.93094 14.0001 2.66732 14.0001H13.334C14.0704 14.0001 14.6673 13.4031 14.6673 12.6667V6.00008C14.6673 5.2637 14.0704 4.66675 13.334 4.66675Z" stroke="#25282B" stroke-width="1.33333" stroke-linecap="round" stroke-linejoin="round"/>
                                    <path d="M10.6673 14V3.33333C10.6673 2.97971 10.5268 2.64057 10.2768 2.39052C10.0267 2.14048 9.68761 2 9.33398 2H6.66732C6.3137 2 5.97456 2.14048 5.72451 2.39052C5.47446 2.64057 5.33398 2.97971 5.33398 3.33333V14" stroke="#25282B" stroke-width="1.33333" stroke-linecap="round" stroke-linejoin="round"/>
                                </svg>
                                <p>{conditions}</p>
                            </div>
                            <div className="house-feature house-feature__investors">
                                <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M12.6673 3.33325L3.33398 12.6666" stroke="#444444" strokeWidth="1.33333" strokeLinecap="round" strokeLinejoin="round"/>
                                    <path d="M4.33268 6.00008C5.25316 6.00008 5.99935 5.25389 5.99935 4.33341C5.99935 3.41294 5.25316 2.66675 4.33268 2.66675C3.41221 2.66675 2.66602 3.41294 2.66602 4.33341C2.66602 5.25389 3.41221 6.00008 4.33268 6.00008Z" stroke="#444444" stroke-width="1.33333" stroke-linecap="round" stroke-linejoin="round"/>
                                    <path d="M11.6667 13.3333C12.5871 13.3333 13.3333 12.5871 13.3333 11.6667C13.3333 10.7462 12.5871 10 11.6667 10C10.7462 10 10 10.7462 10 11.6667C10 12.5871 10.7462 13.3333 11.6667 13.3333Z" stroke="#444444" stroke-width="1.33333" stroke-linecap="round" stroke-linejoin="round"/>
                                </svg>
                ...
                <div className="card-btns">
                    <div className="checkout">
                        <CheckoutButton className="blue-checkout-btn" children={'Инвестировать'} active={true}/>
                    </div>
                </div>
            </div>
        </div>
