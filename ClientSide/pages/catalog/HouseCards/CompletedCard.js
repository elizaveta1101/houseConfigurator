...
function CompletedCard({ address, author_id, bathrooms, year_percent, style, bedrooms, codename, conditions, cost, floors, id, infrastructure, long_info, materials, name, short_info, size, square ,style_id, time, type, onClickAddHouse }) {
    ...
    return (
        <div className="card-wrapper">
            <div className="triangle">
                <svg onClick={onAddHouse} className="heart" id={id} width="18" height="16" viewBox="0 0 18 16" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="card-img">
                <Link to="/completed_house_page"><img src={CompletedHouseImg} alt="CompletedHouseImg"/></Link>
            </div>
            <div className="card-info">
                ...
                <div className="house-name">
                    <Link to="/completed_house_page"><h1>{name}</h1></Link>
                </div>
                        ...
                        <div className="left-house-feature">
                            <div className="house-feature">
                                <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M4.33333 1H2.33333C1.97971 1 1.64057 1.14048 1.39052 1.39052C1.14048 1.64057 1 1.97971 1 2.33333V4.33333M13 4.33333V2.33333C13 1.97971 12.8595 1.64057 12.6095 1.39052C12.3594 1.14048 12.0203 1 11.6667 1H9.66667M9.66667 13H11.6667C12.0203 13 12.3594 12.8595 12.6095 12.6095C12.8595 12.3594 13 12.0203 13 11.6667V9.66667M1 9.66667V11.6667C1 12.0203 1.14048 12.3594 1.39052 12.6095C1.64057 12.8595 1.97971 13 2.33333 13H4.33333" stroke="#444444" stroke-width="1.33333" stroke-linecap="round" stroke-linejoin="round"/>
                                </svg>
                                <p>{square} м2</p>
                            </div>
                            <div className="house-feature">
                                <svg width="16" height="14" viewBox="0 0 16 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M14.0939 7.84131H11.7194C11.3742 7.84131 11.0944 8.12112 11.0944 8.46631C11.0944 8.81149 11.3742 9.09131 11.7194 9.09131H12.5855L9.58737 12.0894C9.34327 12.3335 9.34327 12.7292 9.58737 12.9732C9.83143 13.2173 10.2271 13.2174 10.4712 12.9733L13.4694 9.97518V10.8413C13.4694 11.1865 13.7492 11.4663 14.0944 11.4663C14.4396 11.4663 14.7194 11.1865 14.7194 10.8413V8.46631C14.7194 8.46621 14.7194 8.46612 14.7194 8.46603C14.7192 8.1264 14.4432 7.84106 14.0939 7.84131Z" fill="#444444"/>
                                    <path d="M15.375 0.84375H11.6875C11.3423 0.84375 11.0625 1.12356 11.0625 1.46875V4.53125H8.00003C7.65488 4.53125 7.37503 4.81106 7.37503 5.15625V8.21875H4.31253C3.96734 8.21875 3.68753 8.49856 3.68753 8.84375V11.9062H0.625C0.279813 11.9062 0 12.1861 0 12.5312C0 12.8764 0.279813 13.1562 0.625 13.1562H4.31253C4.47828 13.1562 4.63728 13.0904 4.75447 12.9732C4.87169 12.856 4.93753 12.697 4.93753 12.5312L4.9375 9.46875H8.00003C8.16578 9.46875 8.32478 9.40291 8.44197 9.28569C8.55919 9.1685 8.62503 9.0095 8.62503 8.84375L8.625 5.78125H11.6875C11.8533 5.78125 12.0122 5.71541 12.1294 5.59819C12.2467 5.481 12.3125 5.322 12.3125 5.15625L12.3125 2.09375H15.375C15.7202 2.09375 16 1.81394 16 1.46875C16 1.12356 15.7202 0.84375 15.375 0.84375Z" fill="#444444"/>
                                </svg>
                                <p>этажи: {floors}</p>
                            </div>
                        </div>
                        <div className="right-house-feature">
                            <div className="house-feature">
                                <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M10 2H14V6" stroke="#444444" strokeWidth="1.33333" strokeLinecap="round" strokeLinejoin="round"/>
                                    <path d="M6 14H2V10" stroke="#444444" strokeWidth="1.33333" strokeLinecap="round" strokeLinejoin="round"/>
                                    <path d="M13.9997 2L9.33301 6.66667" stroke="#444444" strokeWidth="1.33333" strokeLinecap="round" strokeLinejoin="round"/>
                                    <path d="M2 13.9999L6.66667 9.33325" stroke="#444444" strokeWidth="1.33333" strokeLinecap="round" strokeLinejoin="round"/>
                                </svg>
                                <p>{size} м</p>
                            </div>
                            <div className="house-feature">
                                <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M14.0003 2.66675H2.00033C1.26395 2.66675 0.666992 3.2637 0.666992 4.00008V12.0001C0.666992 12.7365 1.26395 13.3334 2.00033 13.3334H14.0003C14.7367 13.3334 15.3337 12.7365 15.3337 12.0001V4.00008C15.3337 3.2637 14.7367 2.66675 14.0003 2.66675Z" stroke="#444444" stroke-width="1.33333" stroke-linecap="round" stroke-linejoin="round"/>
                                    <path d="M0.666992 6.66675H15.3337" stroke="#444444" strokeWidth="1.33333" strokeLinecap="round" strokeLinejoin="round"/>
                                </svg>
                    ...
                    <div className="card-placeholder">
                        <div className="card-placeholder-box">
                            <svg width="8" height="8" viewBox="0 0 8 8" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M7 3.33325C7 5.66659 4 7.66659 4 7.66659C4 7.66659 1 5.66659 1 3.33325C1 2.5376 1.31607 1.77454 1.87868 1.21193C2.44129 0.649322 3.20435 0.333252 4 0.333252C4.79565 0.333252 5.55871 0.649322 6.12132 1.21193C6.68393 1.77454 7 2.5376 7 3.33325Z" stroke="#ADADAD" stroke-width="0.666667" stroke-linecap="round" stroke-linejoin="round"/>
                                <path d="M4 4.33325C4.55228 4.33325 5 3.88554 5 3.33325C5 2.78097 4.55228 2.33325 4 2.33325C3.44772 2.33325 3 2.78097 3 3.33325C3 3.88554 3.44772 4.33325 4 4.33325Z" stroke="#ADADAD" stroke-width="0.666667" stroke-linecap="round" stroke-linejoin="round"/>
                            </svg>
                            <p>Местоположение</p>
                        </div>
                        <h1>{address}</h1>
                ...
                <div className="card-btns">
                    <div className="checkout">
                        <CheckoutButton className="blue-checkout-btn" children={'Оформить заказ'} active={true}/>
                    </div>
