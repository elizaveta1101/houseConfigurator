        ...
        <div className="saved-card">
            ...
            <div className="saved-card-info">
                ...
                <div className="saved-card-info-btn-1">
                    <CheckoutButton className="saved-projects-card-1" children={'Оформить заказ'} active={true} />
                </div>
                <div className="saved-card-info-btn-2">
                    <CheckoutButton className="saved-projects-card-2" children={'Открыть в редакторе'} active={true}/>
                </div>
            </div>
        </div>
    );
