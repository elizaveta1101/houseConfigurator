    ...
    return (
        <>
            <div className="completed-circle">
                <svg className="completed-circle-1" width="110" height="110" viewBox="0 0 120 120" stroke-width="2.5">
                    <circle className="completed-circle-1-preload" cx="60" cy="60" r="58.2" fill="none" stroke="#325FFF" opacity={0.1} stroke-width="3" stroke-dasharray="0 400"/>
                </svg>
                <svg className="completed-circle-2" width="110" height="110" viewBox="0 0 120 120" stroke-width="2.5">
                    <circle className="completed-circle-2-preload" cx="60" cy="60" r="58.2" fill="none" stroke="#325FFF" opacity={0.1} stroke-width="2" stroke-dasharray="0 400"/>
                </svg>

                <Link to="/catalog"><div className="completed-btn-hover">
                    <div className="completed-btn-circle1-hover">
                        <svg className="completed-btn-circle1-preload" width="110" height="110" viewBox="0 0 120 120" stroke-width="2.5">
                            <circle className="completed-btn-circle1-preload" cx="60" cy="60" r="57.6" fill="none" stroke="#325FFF" stroke-width="6" stroke-dasharray="0 400"/>
                        </svg>
                    </div>
                    <div className="completed-btn-circle2-hover">
                        <svg className="completed-btn-circle2" width="110" height="110" viewBox="0 0 120 120" stroke-width="2.5">
                            <circle className="completed-btn-circle2-preload" cx="60" cy="60" r="57.6" fill="none" stroke="#325FFF" stroke-width="3" stroke-dasharray="0 400"/>
                        </svg>
                    </div>
